...
async def nicecock(ctx):
    ...
    if voice and voice.is_connected():
        ...
        source = FFmpegPCMAudio('nice.mp3')
...
async def harderdaddy(ctx):
    ...
    if voice and voice.is_connected():
        ...
        voice = await channel.connect()
        source = FFmpegPCMAudio('daddy.mp3')
        player = voice.play(source)
        await asyncio.sleep(4)
        await voice.disconnect()
...
async def dejavu(ctx):
    ...
    if voice and voice.is_connected():
        ...
        voice = await channel.connect()
        source = FFmpegPCMAudio('dejavu.mp3')
        player = voice.play(source)
        await asyncio.sleep(6)
        await voice.disconnect()

@bot.command(pass_context=True)
async def icansuckyourdick(ctx):
    channel = ctx.message.author.voice.channel
    if not channel:
        await ctx.send("> Not connected to a voice channel")
        return
    ...
    if voice and voice.is_connected():
        ...
        voice = await channel.connect()
        source = FFmpegPCMAudio('ican.mp3')
        player = voice.play(source)
        await asyncio.sleep(6)
        await voice.disconnect()
...
async def justin(ctx):
    ...
    if voice and voice.is_connected():
        ...
        voice = await channel.connect()
        source = FFmpegPCMAudio('justin.mp3')
        player = voice.play(source)
